...
import { fetchMarketData } from './utils/catalogApi';
...
export default function App() {
  ...
  // Async desde la Fase 1 de migración de catálogo: la búsqueda de datos de
  // mercado ahora consulta /api/catalog-lookup (KV), no un import estático.
  const handleAnalyze = async (inputData) => {
    ...
    if (inputData.id) {
      ...
      const marketData = await fetchMarketData(inputData.customTitle);
